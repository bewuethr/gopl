// Package ch12ex08 provides an S-expression decoder using an io.Reader instead
// of a byte slice.
package ch12ex08
...
// Decode reads the next S-expression from its input and stores it in the value
// pointed to by v.
